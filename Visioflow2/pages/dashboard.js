...
const PACK_COLOR = { essentiel: '#6b7280', premium: '#0071E3', franchise: '#7c3aed' }
const PACK_LABEL = { essentiel: 'Essentiel', premium: 'Premium', franchise: 'Franchise' }
const PACK_PRICE = { essentiel: 150, premium: 490, franchise: 990 }

const DEFAULT_CFG = {
  exampleUrls: { essentiel: '', premium: '', franchise: '' },
  packs: {
    essentiel: { price: '150€', desc: 'Site vitrine + gestion autonome' },
    premium:   { price: '490€', desc: 'Commandes en ligne & livraison' },
    franchise: { price: '990€', desc: 'Multi-établissements & livraison' }
  },
  hero: {
  ...
  payment: {
    ...
    franchise: { stripe: 'https://buy.stripe.com/00w7sEgJTdTL5qvajjdUY05', paypal: 'https://paypal.me/AdelinaLallinaj/990EUR' },
  }
}
    ...
    <div>
      ...
      {section === 'urls' && (
        <div className="db-card">
          ...
          {['essentiel', 'premium', 'franchise'].map(pack => (
...
function buildAIPrompt(group, cfg) {
  ...
  if (pack === 'premium' || pack === 'franchise') lines.push('- Système de commandes en ligne avec panier')
  if (pack === 'franchise') lines.push('- Interface multi-établissements')
