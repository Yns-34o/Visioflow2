...
function setFormPack(pack){
  formPack=pack;
  const info={essentiel:{name:'Pack Essentiel',price:'150€',col:'#6B7280'},premium:{name:'Pack Premium',price:'490€',col:'#0071E3'}};
  const p=info[pack];
...
window.goToForm = function(pack){
  ...
  window.scrollTo({top:0,behavior:'smooth'});
  var info={essentiel:{name:'Pack Essentiel',price:'150€',col:'#6B7280'},premium:{name:'Pack Premium',price:'490€',col:'#0071E3'}};
...
window.formSubmit = window.formSubmit || function(){
  ...
  var links={essentiel:'https://buy.stripe.com/8x228kbpzaHz8CHajjdUY07',premium:'https://buy.stripe.com/7sYbIUfFPdTL1afdvvdUY06'};
  var s3=document.getElementById('form-step-3');
  var sc=document.getElementById('form-step-success');
  if(s3) s3.style.display='none';
  if(sc) sc.style.display='';
  window.scrollTo({top:0,behavior:'smooth'});
  var url=links[pack];if(url) setTimeout(function(){window.location.href=url;},2000);
};
...
(function () {
  ...
  window.vfPPSubmit = async function() {
    ...
    const projectDoc = {
      ...
      pack,
      prixPack:     { essentiel:150, premium:490 }[pack] || 490,
