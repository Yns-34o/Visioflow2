...
function selectPack(packId){
  ...
  ['essentiel','premium','franchise'].forEach(id=>{
    document.getElementById('ps-'+id).className='pselbtn'+(id===packId?' a':'');
  });
...
function setFormPack(pack){
  formPack=pack;
  const info={essentiel:{name:'Pack Essentiel',price:'150€',col:'#6B7280'},premium:{name:'Pack Premium',price:'490€',col:'#0071E3'},franchise:{name:'Pack Franchise',price:'990€',col:'#8338EC'}};
  const p=info[pack];
...
function renderFormCities(){
  ...
  container.innerHTML=formCities.map((c,i)=>{
    return '<div class="form-city-block">'
      ...
      +(i>0?'<button class="form-city-remove" onclick="formRemoveCity('+i+')">&times;</button>':'')
      +'</div>'
    ...
    <div class="cl-card">
      ...
      <div class="cl-form" id="cl-login-form">
        ...
        <div class="cl-field">
          ...
          <input type="password" id="cl-log-pw" placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" onkeydown="if(event.key==='Enter')doClientLogin()"/>
        </div>
      ...
      <div class="cl-form" id="cl-register-form" style="display:none">
        ...
        <div class="cl-field">
          ...
          <input type="password" id="cl-reg-pw" placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" onkeydown="if(event.key==='Enter')doClientRegister()"/>
        </div>
        <div class="cl-field">
          <label>Confirmer</label>
          <input type="password" id="cl-reg-pw2" placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" onkeydown="if(event.key==='Enter')doClientRegister()"/>
        </div>
  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-form-auth" id="auth-login-form">
        ...
        <div class="login-field">
          <label>Mot de passe</label>
          <input type="password" id="login-password" placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" onkeydown="if(event.key==='Enter')doAdminLogin()"/>
        </div>
...
authDiv.innerHTML = `
  ...
  <div id="nav-user-area" style="display:none">
    <button class="nav-user-badge" id="nav-user-name" onclick="showPage('admin')">
...
(function () {
  ...
  _authOv.innerHTML = `
    <div class="vf-auth-card">
      ...
      <div class="vf-auth-form" id="vf-form-log">
        ...
        <div class="vf-af-f"><label class="vf-af-l">Mot de passe</label><input class="vf-af-i" type="password" id="vf-log-pw" placeholder="••••••••" onkeydown="if(event.key==='Enter')vfDoLogin()"/></div>
      ...
      <div class="vf-auth-form" id="vf-form-reg" style="display:none">
        ...
        <div class="vf-af-f"><label class="vf-af-l">Mot de passe <span style="color:var(--text3);font-weight:400">(min. 6 car.)</span></label><input class="vf-af-i" type="password" id="vf-reg-pw" placeholder="••••••••" onkeydown="if(event.key==='Enter')vfDoRegister()"/></div>
    ...
    if (currentFBUser) {
      ...
      drop.innerHTML = `
        ...
        <div class="vf-drop-body">
          ${isAdmin
            ? `<button class="vf-dbtn blue" onclick="vfToggleDrop();showPage('admin')"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>Dashboard Admin</button>`
  ...
  async function _renderEC () {
    ...
    wrap.innerHTML = `
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:16px">
        ...
        <button class="ba" style="font-size:13px;padding:10px 22px" onclick="showPage('offres')">Configurer un nouveau site →</button>
      </div>
    `;
    await _loadProjects();
  }
  ...
  function _renderActiveCityForm() {
    ...
    container.innerHTML =
      ...
      '<option value="48h" ' + ((city.delai||'48h')==='48h'?'selected':'') + '>Standard — 48h</option>' +
      ...
      body.innerHTML = `${cbar}
        ...
        <div class="vf-pp-field"><label class="vf-pp-lbl">Délai de livraison souhaité</label>
          <select class="vf-pp-inp" id="pp-delai">
            <option value="48h" ${(_ppData.delai||'48h')==='48h'?'selected':''}>Standard — 48h</option>
  ...
  return (
    <>
      ...
      <div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: PAGE_HTML }} />
    </>
  )
}